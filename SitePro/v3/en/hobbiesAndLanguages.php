    ...
    <div class="row bg-dark text-white m-0 p-0" >
        <div class=" col-12 text-center"></br><h2><i class="fas fa-globe-europe" style="color: #ffffff;"></i> Languages et Personal interests  </h2></br></div>
    </div>
    ...
    <div class="row align-self-center m-4">
        ...
        <div class="col-4 text-justify">
            ...
            <div class="row-8">
                <p><h5><img style="height: 30px" src="francais.png"> French</h5> Native language</p>

                <p><h5><img style="height: 30px" src="anglais.png"> English</h5>European level C1 - TOIEC 950 </p>
                
                <p><h5><img style="height: 30px" src="espagnol.png"> Espagnol</h5>European level B2</p>

                <p><h5><img style="height: 30px" src="Coree.png"> Coréen</h5> Certified level 3</p>
            </div>
