    ...
    <div class="row align-self-center m-4">
        ...
        <div class="col-4 text-justify">
            ...
            <div class="row-8">
                <p><h5><img style="height: 30px" src="anglais.png"> Anglais</h5> Niveau C1 - TOIEC 950 </p>
                
                <p><h5><img style="height: 30px" src="espagnol.png"> Espagnol</h5> Niveau B2</p>

                <p><h5><img style="height: 30px" src="Coree.png"> Coréen</h5> Intermédiaire certifiée</p>

                <p><h5><img style="height: 30px" src="japonais.png"> Japonais</h5> Notions</p>
            </div>
